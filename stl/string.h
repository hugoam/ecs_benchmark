...
namespace stl {
	...
	extern template string operator+(const string& lhs, const string& rhs);
	extern template string operator+(const char* lhs, const string& rhs);
	extern template string operator+(const string& lhs, const char* rhs);
}
#endif
